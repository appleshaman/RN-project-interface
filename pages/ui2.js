...
class UI2 extends Component {
    ...
    priceCaculation = () => {
        let price = 0;
        for (i = 0; i < this.state.data.length; i++) {
            price += this.state.data[i].amount;
        }
        return price;
    }
    ...
    item = (item) => {
        return (
            <View style={styles.theShadowContainer}>
                ...
                <Text style={styles.theGreenText}>{item.name}</Text>
                ...
                <Text style={styles.theRedText}>{item.amount.toString()}</Text>
            </View>
        );
    }
    /**(
        ...
        return (
            <View style={{ flexDirection: "column", height: "100%" }}>
                ...
                <View style={styles.theShadowContainerForListTitle}>
                        <Text style={styles.theGreenText}>{"批发档口商户"}</Text>
                        <Text style={styles.theGreenText}>{"品名规格"}</Text>
                        <Text style={styles.theGreenText}>{"件数/数量"}</Text>
                        <Text style={styles.theGreenText}>{"均价"}</Text>
                        <Text style={styles.theGreenText}>{"货款"}</Text>
                </View>
                ...
                <View style={styles.theShadowContainerForLast}>
                    <Text style={{ color: 'red', fontSize: 20,alignItems:'center' }}>
